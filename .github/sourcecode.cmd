...
If Exist "source\*.mp4" (
    ...
    For /f "Skip=1 Tokens=1,3" %%A In ('Wmic path Win32_VideoController get VideoModeDescription') Do Start /b /w "" FFmpeg.exe -i "source\!video!.mp4" -y -q:v 0 -r 45 -s %%Ax%%B "!tmp!/seq/F%%d.jpg"
    Start /b /w "" FFmpeg.exe -i "source\!video!.mp4" -y -q:v 0 -r 45 -s 640x360 "!tmp!/seq/M%%d.jpg"
